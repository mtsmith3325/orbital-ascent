...
export function renderExperience() {
  return `
    ...
    <section class="page-hero page-hero--has-bg">
      <img class="page-hero-bg" src="/src/images/journey/joureny-hero.png" alt="" aria-hidden="true">
    ...
    <section class="page-editorial">
      <div class="editorial-block reveal">
        ...
        <div class="editorial-media">
          <img src="/src/images/journey/01-launch.jpg" alt="" />
        </div>
      </div>
      ...
      <div class="editorial-block reveal stagger-1">
        ...
        <div class="editorial-media">
          <img src="/src/images/journey/02-weightlessness.jpg" alt="" />
        </div>
      </div>
      ...
      <div class="editorial-block reveal stagger-2">
        ...
        <div class="editorial-media">
          <img src="/src/images/journey/03-view.png" alt="" />
        </div>
      </div>
      ...
      <div class="editorial-block reveal stagger-3">
        ...
        <div class="editorial-media">
          <img src="/src/images/journey/04-reentry.png" alt="" />
        </div>
      </div>
    </section>
